...
const mockData = [
  ...
  },
  {
    id: 2,
    substance: '마늘',
    symptoms: '구토, 무력감, 빈혈로 휘청거림, 설사, 식욕부진, 호흡곤란 / 혈뇨 : 간장색, 갈색, 적색',
    petType: '강아지 · 고양이',
    risk: '높음',
  },
  {
    id: 3,
    substance: '마카다미아',
    symptoms: '고열, 구토, 권태감, 복통, 무기력, 비틀거림, 소화불량, 설사, 충혈',
    petType: '강아지 · 고양이',
    risk: '높음',
  },
  {
    id: 4,
    substance: '아보카도',
    symptoms: '구토, 경련, 보랏빛 혀, 복통, 붉은 가래, 붓기, 설사, 식욕저하, 축축한 기침, 호흡 곤란',
    petType: '강아지 · 고양이',
    risk: '높음',
  },
  {
...
const Danger = () => {
  return (
    <>
      ...
      <BoardList substance='음식명' effect='먹은 후 나타나는 증상' mockData={mockData} />
    </>
  );
};
