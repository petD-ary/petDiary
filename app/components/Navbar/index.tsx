...
const NAVBAR: NavItem[] = [
  {type: 'home', pathname: '/', push: '/', content: '홈', icon: IconHome, selectedIcon: IconSelectedHome},
  {type: 'calendar', pathname: '/calendar', push: '/calendar', content: '캘린더', icon: IconCalendar, selectedIcon: IconSelectedCalendar},
  {type: 'info', pathname: '/info', push: '/info', content: '반려지식', icon: IconInfo, selectedIcon: IconSelectedInfo},
  {type: 'community', pathname: '/community', push: '/community', content: '커뮤니티', icon: IconCommunity, selectedIcon: IconSelectedCommunity},
